      ...
      <div className="guide-body">
        ...
        <main className="guide-content" ref={contentRef}>
          ...
          <section id="communication">
            ...
            <p>
              교신은 트릭과 트릭 사이, 즉 현재 트릭에 아직 아무도 카드를 내지
              않았을 때만 할 수 있습니다(미션의 첫 트릭이 시작되기 전도
              포함됩니다). 매 트릭이 시작될 때마다 기회는 새로 생기지만, 한
              번의 시도(도전)에서 실제로 쓸 수 있는 건 대원 한 명당 평생 딱
              한 번뿐입니다.
            </p>
            <p>
          ...
          <section id="how-to-play">
            ...
            <ol className="how-to-play-steps">
              ...
              <li>
                트릭이 시작되기 전, 원한다면 교신을 한 번 사용합니다(선택
                사항이며 건너뛸 수 있습니다).
              </li>
